-- Migration: Create get_user_catalogs function for efficient catalog retrieval with points calculation
-- This function provides paginated catalog listing with real-time total_points calculation
...
COMMENT ON FUNCTION pathly.get_user_catalogs IS 
'Retrieves paginated list of user catalogs with calculated total GOT points. Supports filtering by type and sorting.';
